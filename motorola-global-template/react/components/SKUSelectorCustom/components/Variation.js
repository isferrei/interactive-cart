...
import { imageUrlForSize, VARIATION_IMG_SIZE } from '../module/image'
...
const findSelectedOption = (selectedItem) => findIndex(propEq('label', selectedItem));
    ...
    <div className={containerClasses}>
      <div className={`${styles.skuSelectorNameContainer} ma1`}>
        <div className={`${styles.skuSelectorTextContainer} db mb3`}>
          ...
          {selectedItem && showValueForVariation && isColor(name) && (
            <Fragment>
              <span
