...
export function slug(str) {
    ...
    const replaced = (str === null || str === void 0 ? void 0 : str.replace(/[*+~.()'"!:@&\[\]]/g, '')) || '';
...
export function cleanImageUrl(imageUrl) {
    var _a;
    const result = (_a = baseUrlRegex.exec(imageUrl)) !== null && _a !== void 0 ? _a : [];
...
export function changeImageUrlSize(imageUrl, width = DEFAULT_WIDTH, height = DEFAULT_HEIGHT) {
    if (!imageUrl)
        return;
...
export function getValidMarginBottom(variationsSpacing) {
