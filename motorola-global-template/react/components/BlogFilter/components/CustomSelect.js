...
import "./CustomSelect.global.css";
...
class CustomSelect extends React.Component {
  ...
  handleOptionClick = e => {
    ...
    if (this.props.click) {
      this.props.click(e.target.getAttribute("data-name"));
    }
  };

  resetDropDown = () => {
    this.setState({ defaultSelectText: this.props.defaultText, showOptionList: false });
  };
