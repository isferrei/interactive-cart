...
import "./pdpProcessorFullBleed.global.css";
import { Controller, Scene } from "react-scrollmagic";

class PdpProcessorFullBleed extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <div
        className="pdp-processor"
        style={{
          backgroundColor: "#" + bgColor
        }}
      >
        <div
          className={"pp-image-layer " + bgImageAlignmentDesktop + "-aligned"}
        >
          <Controller>
            <Scene
              triggerHook={0.8}
              classToggle="zoom-in-effect"
              triggerElement=".pp-image-layer"
              reverse={true}
            >
        ...
        <div className="pp-text-layer">
          {this.state.displayText ? (
            <div className="pp-text-container">
              <div
                className={
                  "pp-text-content " + textAlignmentDesktop + "-aligned"
                }
              >
                <div className="pp-center-vertical">
                  <div
                    className={"pp-title " + titleTextOutline}
                    style={{
                  ...
                  <div className="pp-desc">{descText}</div>
                </div>
              </div>
            </div>
          ) : null}
