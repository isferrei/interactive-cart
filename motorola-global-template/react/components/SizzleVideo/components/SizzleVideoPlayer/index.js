              ...
              <div className={`sv-main-video ${!this.state.playPauseFlag && this.state.playIconFlag ? 'active' : ''}`} >
                <div className="sv-main-video-player">
                  <ReactPlayer
                    ...
                    onReady={event => {
                      this.setState({ playingVideo: true });
                      this.handleScroll('sv-react-player-main', false);
                    }}
